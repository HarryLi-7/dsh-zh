window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const TURN_STATUS_STYLE = [
      `[${TURN_STATUS_MARK}] { background-position: 100% 0 !important; background-size: 250% 100% !important; animation: 1.8s linear infinite dsh-zh-turn-status-shimmer !important; }`,
      `@keyframes dsh-zh-turn-status-shimmer { to { background-position: 0 0; } }`
    ].join("\n");
